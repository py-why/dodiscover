...
- |Feature| Add conditional k-sample (discrepancy) test, :class:`dodiscover.cd.KernelCDTest`, by `Adam Li`_ (:pr:`57`)
- |Feature| Add conditional k-sample (discrepancy) test, :class:`dodiscover.cd.BregmanCDTest`, by `Adam Li`_ (:pr:`57`)
